...
- **2-device refresh check + multi-human draft rehearsal** — the only unverified part of Session 38; browser-side behavior no sim can prove. Do this before the official re-draft.
