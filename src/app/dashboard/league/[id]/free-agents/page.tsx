...
// Current NFL week helper (mirrors matchups/page.tsx)
...
export default async function FreeAgentsPage({
  ...
  // All rostered player IDs in this league (to exclude from free agents list)
  const { data: allRostered } = await supabase
    .from("uff_roster_players")
    .select("player_id, league_members!inner(league_id)")
